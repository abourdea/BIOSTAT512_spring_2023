...
/*****this part is not done yet but I (grace) wanted to upload the rest of it*****/
title "Model 4: no random effects";
proc reg data=cabg method=reml;
  class dshospid id female cm_obese pay1 race hosp_cntrl hosp_teach;
  model log_los = age wcharlsum female cm_obese pay1 race hosp_cntrl hosp_teach hospN prop_cabg;
run;
/**********************************************************************************/
